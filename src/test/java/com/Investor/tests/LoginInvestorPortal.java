...
import com.locators.allPages.InvestorPortalProfile;
...
public class LoginInvestorPortal extends Baseclass {

//	// TC_IP_Login_001
//	
//	  @Test(priority = 1) public void validUserLogin() throws IOException { 
//		  try {
...
//	 
//	            // Verify that logged in user name is visible on top of Dashboard  page
...
//	  
//	  // TC_IP_Login_002
//	  @Test(priority = 2) public void invalidUserNameLogin() throws IOException {
//		  
//		  try { 
...
//	  
//	  // TC_IP_Login_003
//	 @Test(priority = 3) public void invalidPasswordLogin() throws IOException {
//		 try { 
...
//	 
//	 // TC_IP_Login_004
//	 @Test(priority = 4) public void skipUserNameAndTryLogin() throws IOException {
//		 try { 
...
//	 }
//	// TC_IP_Login_005
//	 @Test(priority = 5) public void skipPasswordAndTryLogin() throws IOException { 
//		 try { 
...
//		 try { 
//			 extenttest = extent.createTest("Verify that when user click on Forget Password link then user navigate to the Forget Password page")
//					 .assignCategory(investor_tag + "_" + env);
//		 node =extenttest.createNode("Report");
//		 
//		 // Call the loadLoginPage function from the utils login
...
//			 
//			 // Take the failed case screenshot 
//			 String screenpath =  IScreenAction.captureScreenShot_FailedCase(driver,"validateForgetPasswordRedirection_Fail");
//			 node.log(Status.FAIL,"Some Assertion Error" + extenttest.addScreenCaptureFromPath(screenpath));
...
//		try { 
//			extenttest = extent.createTest("Verify that when the user enters an invalid Email id then error message is displayed.")
//				.assignCategory(investor_tag + "_" + env); 
//			node = extenttest.createNode("Report");
//			
//			// Call the loadLoginPage function from the utils login
...
//		try { extenttest = 
//				extent.createTest("Verify when the user clicks on the 'Sign in' link then the user navigates to the Sign-in page")
//				.assignCategory(investor_tag + "_" + env); 
//		node = extenttest.createNode("Report");
//		
//		// Call the loadLoginPage function from the utils login
...
//				"STEP8 : BUG - Sign in page is not displayed",
//				"STEP5 : EXPECTED - Sign in page is displayed");
//		
//		// Take Screenshot of dashboard after user login
...
//		
//			// Take the failed case screenshot 
//			String screenpath = IScreenAction.captureScreenShot_FailedCase(driver, "validateSignInRedirectionFromForgotPassword_Fail"); 
//			node.log(Status.FAIL,"Some Assertion Error" + extenttest.addScreenCaptureFromPath(screenpath));
//			
...
//	 	 
	...
	public void validateResetPasswordUsingChangePassword() throws IOException {
		try {
			...
			updateDataOnExcel(73, password);
			System.out.println(getDataFromExcel(73) + "is old password");
			
//			updateDataOnExcel(75, newPassword);
//			System.out.println(getDataFromExcel(75) + "is new password");
			...
			Utils.clickOnMenu(node, driver, ResetPasswordPO.loggedinusername);

			// Click on the view personal profile
			Utils.clickOnMenu(node, driver, ResetPasswordPO.viewpersonalprofile);

			Utils.clickOnMenu(node, driver, InvestorPortalProfile.changePasswordLink);
			...
			IWaitStrategy.waitForVisiblity(node, driver, InvestorPortalProfile.changePasswordLink);
			...
			IElementActions.clickelement_usingXpath(node, driver, InvestorPortalProfile.changePasswordLink);
			...
			IWaitStrategy.waitForVisiblity(node, driver, InvestorPortalProfile.changePasswordText);
			...
			IElementActions.clickAndInput_usingXpath(node, driver, InvestorPortalProfile.oldPassword, password);
			...
			IElementActions.clickAndInput_usingXpath(node, driver, InvestorPortalProfile.newPassword, newPassword);
			...
			IElementActions.clickAndInput_usingXpath(node, driver, InvestorPortalProfile.confirmPassword, newPassword);
			...
			IElementActions.clickelement_usingXpath(node, driver, InvestorPortalProfile.saveButton);
